...
Since needers have to be logged online to wait for answers, have to wait for solutions, thus they are most likely potential voter nodes. These nodes can be seen as super nodes that can be used to handle extra services.
