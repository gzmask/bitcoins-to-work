...
\begin{enumerate}
	\item a node $U_1$ boardcasts, in $Log(N)$ time, a need $N_1$ in the network while deposits O bitcoins into $W_1$ as an offer.
...
\begin{enumerate}
	...
	\item $U_{log(K)}$ notifies needer, worker and other voters the result.
